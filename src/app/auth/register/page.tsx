    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-1">创建你的 OfferPilot 账号</p>
        </div>
        ...
        >
          <div>
            <label htmlFor="name" className="block text-sm font-medium mb-1">昵称</label>
            <input
        ...
        <p className="text-center text-sm text-muted-foreground">
          已有账号？<a href="/auth/login" className="text-blue-500 hover:underline">登录</a>
        </p>
      </div>
    </main>
  );
